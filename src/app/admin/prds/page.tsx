...
export default function AdminPRDsPage() {
   ...
   return (
      <AdminLayout title="PRD Management" subtitle="Review and manage user PRDs">
         <div className="p-6">
            {loading ? (
                           ...
                           <div className="border-t border-gray-200 dark:border-gray-700 p-4 space-y-4">
                              ...
                              <div className="flex items-center space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                 ...
                                 <button
                                    ...
                                    className="flex-1 flex items-center justify-center space-x-2 px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                 >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
