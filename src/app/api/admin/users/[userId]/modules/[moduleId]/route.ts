...
export async function PATCH(
    ...
    try {
        ...
        if (action === "update_task") {
            ...
            const taskIndex = targetModule.tasks.findIndex(t =>
                (t as any)._id.toString() === taskId
            );
            ...
            const standupIndex = targetModule.standups.findIndex(s =>
                (s as any)._id.toString() === standupId
            );
